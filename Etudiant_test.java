...
public class Etudiant_test {
    public static void main(String[] args) {
        ...
        Question question2 = new Question("le meilleur ami de l'homme ?", choix_reponse2, 10, "le chien");
        ...
        Question question4 = new Question("Le rang max de valorant ?", choix_reponse4, 200, "Radiant");
